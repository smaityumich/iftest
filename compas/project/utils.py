...
class Project(keras.layers.Layer):
    ...
    def __init__(self, w):
        ...
        self.w = tf.Variable(shape = (4, 9),initial_value=w,\
                               trainable=False)
        self.input_spec = tf.keras.layers.InputSpec(shape=(None, 9))
...
class ClassifierGraph(keras.Model):
    ...
    def __init__(self, n_hiddens, num_classes, sensetive_directions, input_shape = (9,), seed_model = 1):
